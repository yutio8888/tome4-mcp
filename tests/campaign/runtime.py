...
def source_records(workspace: Path = WORKSPACE) -> dict[str, dict]:
    ...
    paths = {
        "campaign-play-01": ADDON / "docs/mcp-campaign-trial-2026-09-15.json",
        "campaign-play-v030-01": ADDON / "docs/mcp-campaign-continuation-0.3.0.json",
    }
...
class CampaignRuntime(native.Runtime):
    def __init__(self, name: str, source_session: Path = DEFAULT_SESSION,
        ...
        shutil.copytree(ADDON / "server/src", self.server_source,
